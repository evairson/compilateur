...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState022 : (('s, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_STAR, _menhir_box_prog) _menhir_state
    (** State 022.
  ...
  | MenhirState034 : (('s, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_MINUS, _menhir_box_prog) _menhir_state
    (** State 034.
  ...
  | MenhirState054 : ((('s, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_arg_list, _menhir_box_prog) _menhir_state
    (** State 054.
        Stack shape : IDENT LP arg_list.
        Start symbol: prog. *)

  | MenhirState063 : (('s, _menhir_box_prog) _menhir_cell1_RETURN, _menhir_box_prog) _menhir_state
    (** State 063.
        Stack shape : RETURN.
        Start symbol: prog. *)

  | MenhirState067 : (('s, _menhir_box_prog) _menhir_cell1_PRINT _menhir_cell0_LP, _menhir_box_prog) _menhir_state
    (** State 067.
        Stack shape : PRINT LP.
        Start symbol: prog. *)

  | MenhirState072 : (('s, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_state
    (** State 072.
        Stack shape : IF LP.
        Start symbol: prog. *)

  | MenhirState075 : ((('s, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP, _menhir_box_prog) _menhir_state
    (** State 075.
        Stack shape : IF LP expr RP.
        Start symbol: prog. *)

  | MenhirState077 : (('s, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP, _menhir_box_prog) _menhir_state
    (** State 077.
        Stack shape : IDENT LP.
        Start symbol: prog. *)
  ...
  | MenhirState087 : (((('s, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_state
    (** State 087.
        Stack shape : IF LP expr RP seq.
        Start symbol: prog. *)

  | MenhirState090 : ((((('s, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_cell1_RB, _menhir_box_prog) _menhir_state
    (** State 090.
        Stack shape : IF LP expr RP seq RB.
        Start symbol: prog. *)

  | MenhirState091 : (((((('s, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_cell1_RB, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_state
    (** State 091.
        Stack shape : IF LP expr RP seq RB seq.
        Start symbol: prog. *)

  | MenhirState094 : ((('s, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT _menhir_cell0_LP _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_state
    (** State 094.
        Stack shape : TINT IDENT LP RP seq.
        Start symbol: prog. *)

  | MenhirState098 : (('s, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT _menhir_cell0_LP _menhir_cell0_params _menhir_cell0_RP, _menhir_box_prog) _menhir_state
    (** State 098.
        Stack shape : TINT IDENT LP params RP.
        Start symbol: prog. *)

  | MenhirState099 : ((('s, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT _menhir_cell0_LP _menhir_cell0_params _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_state
    (** State 099.
        Stack shape : TINT IDENT LP params RP seq.
        Start symbol: prog. *)

  | MenhirState104 : (('s, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT, _menhir_box_prog) _menhir_state
    (** State 104.
        Stack shape : TINT IDENT.
        Start symbol: prog. *)

  | MenhirState108 : (('s, _menhir_box_prog) _menhir_cell1_IDENT, _menhir_box_prog) _menhir_state
    (** State 108.
        Stack shape : IDENT.
        Start symbol: prog. *)

  | MenhirState112 : (('s, _menhir_box_prog) _menhir_cell1_list_gdef, _menhir_box_prog) _menhir_state
    (** State 112.
...
include struct
    ...
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      ...
      | IDENT _v ->
          ...
          | SEMI ->
              ...
              let _v = _menhir_action_28 _endpos__3_ _startpos__1_ id in
  ...
  and _menhir_goto_list_gdef : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IDENT _v_0 ->
          let _menhir_stack = MenhirCell1_list_gdef (_menhir_stack, _menhir_s, _v) in
          _menhir_run_107 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState112
      | EOF ->
          let p = _v in
  ...
  and _menhir_run_107 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
  ...
  and _menhir_run_017 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s ->
      ...
      | LP ->
          ...
          | _ ->
              _eRR ())
      | AND | COMMA | DIV | EQ | EQS | GE | GT | LE | LT | MINUS | NEQ | NEQS | OR | PLUS | REM | RP | SEMI | STAR ->
  ...
  and _menhir_run_109 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
      ...
      | SEMI ->
          ...
          let _v = _menhir_action_30 _endpos__4_ _startpos_id_ e id in
          _menhir_goto_gdef _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | REM ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_105 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | SEMI ->
          ...
          let _v = _menhir_action_29 _endpos__5_ _startpos__1_ e id in
          _menhir_goto_gdef _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | REM ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_024 _menhir_stack _menhir_lexbuf _menhir_lexer
  ...
  and _menhir_run_084 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | SEMI ->
          ...
          let MenhirCell1_IDENT (_menhir_stack, _menhir_s, id, _startpos_id_, _) = _menhir_stack in
          let (e, _endpos__4_) = (_v, _endpos_0) in
          let _v = _menhir_action_42 _endpos__4_ _startpos_id_ e id in
  ...
  and _menhir_run_093 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_seq -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_seq (_menhir_stack, _menhir_s, s) = _menhir_stack in
      let s2 = _v in
      let _v = _menhir_action_37 s s2 in
  ...
  and _menhir_run_099 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT _menhir_cell0_LP _menhir_cell0_params _menhir_cell0_RP as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TINT ->
      ...
      | IDENT _v_0 ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
          _menhir_run_076 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState099
      | END ->
          let _endpos = _menhir_lexbuf.Lexing.lex_curr_p in
          let _tok = _menhir_lexer _menhir_lexbuf in
          ...
          let _v = _menhir_action_27 _endpos__8_ _startpos__1_ id1 p s in
          _menhir_goto_gdef _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | _ ->
          _eRR ()
    ...
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      ...
      | IDENT _v ->
          ...
          | SEMI ->
              ...
              let _tok = _menhir_lexer _menhir_lexbuf in
              let (_endpos__3_, id, _startpos__1_) = (_endpos_1, _v, _startpos) in
              let _v = _menhir_action_40 _endpos__3_ _startpos__1_ id in
              _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
          | AFFECT ->
              let _menhir_stack = MenhirCell1_TINT (_menhir_stack, _menhir_s, _startpos) in
              let _menhir_stack = MenhirCell0_IDENT (_menhir_stack, _v, _startpos_0, _endpos) in
      ...
      | LP ->
          ...
          | RP ->
              ...
              | SEMI ->
                  ...
                  let _v = _menhir_action_43 _endpos__4_ _startpos_id_ id in
                  _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
              | _ ->
                  _eRR ())
          | NOT ->
          ...
          | IDENT _v_3 ->
              let _menhir_stack = MenhirCell1_IDENT (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
              let _menhir_stack = MenhirCell0_LP (_menhir_stack, _startpos_0) in
              _menhir_run_017 _menhir_stack _menhir_lexbuf _menhir_lexer _v_3 MenhirState077
          | CST _v_4 ->
              let _menhir_stack = MenhirCell1_IDENT (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
              let _menhir_stack = MenhirCell0_LP (_menhir_stack, _startpos_0) in
              _menhir_run_020 _menhir_stack _menhir_lexbuf _menhir_lexer _v_4 MenhirState077
          | _ ->
              _eRR ())
      | AFFECT ->
          let _menhir_stack = MenhirCell1_IDENT (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_094 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT _menhir_cell0_LP _menhir_cell0_RP as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TINT ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
      ...
      | IDENT _v_0 ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
          _menhir_run_076 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState094
      | END ->
          let _endpos = _menhir_lexbuf.Lexing.lex_curr_p in
          let _tok = _menhir_lexer _menhir_lexbuf in
          let MenhirCell0_RP (_menhir_stack, _) = _menhir_stack in
          ...
          let _v = _menhir_action_26 _endpos__7_ _startpos__1_ id1 s in
          _menhir_goto_gdef _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | _ ->
          _eRR ()
  
  and _menhir_run_091 : type  ttv_stack. (((((ttv_stack, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP, _menhir_box_prog) _menhir_cell1_seq, _menhir_box_prog) _menhir_cell1_RB as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TINT ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
      ...
      | RB ->
          ...
          let _v = _menhir_action_46 _endpos__11_ _startpos__1_ e s1 s2 in
          _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | PRINT ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
      ...
      | IDENT _v_0 ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
          _menhir_run_076 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState091
      | _ ->
          _eRR ()
  
  and _menhir_run_087 : type  ttv_stack. (((ttv_stack, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_RP as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TINT ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
      ...
      | RB ->
          ...
          | ELSE ->
              let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
              let _menhir_stack = MenhirCell1_RB (_menhir_stack, MenhirState087, _endpos) in
              let _tok = _menhir_lexer _menhir_lexbuf in
              (match (_tok : MenhirBasics.token) with
              | LB ->
              ...
              | _ ->
                  _eRR ())
          | END | IDENT _ | IF | PRINT | RB | RETURN | TINT ->
              let MenhirCell0_RP (_menhir_stack, _) = _menhir_stack in
              let MenhirCell1_expr (_menhir_stack, _, e, _, _) = _menhir_stack in
              let MenhirCell0_LP (_menhir_stack, _) = _menhir_stack in
              let MenhirCell1_IF (_menhir_stack, _menhir_s, _startpos__1_) = _menhir_stack in
              let (s, _endpos__7_) = (_v, _endpos) in
              let _v = _menhir_action_45 _endpos__7_ _startpos__1_ e s in
              _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
          | _ ->
              _eRR ())
      | PRINT ->
      ...
      | IDENT _v_1 ->
          let _menhir_stack = MenhirCell1_seq (_menhir_stack, _menhir_s, _v) in
          _menhir_run_076 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1 MenhirState087
      | _ ->
          _eRR ()
  ...
  and _menhir_run_073 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IF _menhir_cell0_LP as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      match (_tok : MenhirBasics.token) with
      | STAR ->
  ...
  and _menhir_run_068 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_PRINT _menhir_cell0_LP as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | RP ->
          ...
          | SEMI ->
              ...
              let _v = _menhir_action_38 _endpos__5_ _startpos__1_ e in
              _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
          | _ ->
              _eRR ())
      | REM ->
  ...
  and _menhir_run_064 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_RETURN as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | SEMI ->
          ...
          let _v = _menhir_action_39 _endpos__3_ _startpos__1_ e in
          _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | REM ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_024 _menhir_stack _menhir_lexbuf _menhir_lexer
  ...
  and _menhir_run_061 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_TINT _menhir_cell0_IDENT as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | SEMI ->
          ...
          let MenhirCell1_TINT (_menhir_stack, _menhir_s, _startpos__1_) = _menhir_stack in
          let (e, _endpos__5_) = (_v, _endpos_0) in
          let _v = _menhir_action_41 _endpos__5_ _startpos__1_ e id in
          _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | REM ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_024 _menhir_stack _menhir_lexbuf _menhir_lexer
  ...
  and _menhir_run_060 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_STAR -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
  ...
  and _menhir_run_059 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_NOT -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
  ...
  and _menhir_run_058 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_MINUS -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
  ...
  and _menhir_run_056 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_LP as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_055 : type  ttv_stack. (((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_arg_list as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_080 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | RP ->
          let _tok = _menhir_lexer _menhir_lexbuf in
          ...
          | SEMI ->
              ...
              let _v = _menhir_action_44 _endpos__5_ _startpos_id_ args id in
              _menhir_goto_stmt _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
          | _ ->
              _eRR ())
      | COMMA ->
  ...
  and _menhir_run_054 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP, _menhir_box_prog) _menhir_cell1_arg_list -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
  ...
  and _menhir_run_052 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | RP ->
          let _endpos = _menhir_lexbuf.Lexing.lex_curr_p in
  ...
  and _menhir_run_049 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_028 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | COMMA | EQ | EQS | NEQ | NEQS | OR | RP | SEMI ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_, _) = _menhir_stack in
          let (_endpos_e2_, e2) = (_endpos, _v) in
  ...
  and _menhir_run_043 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_028 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | COMMA | EQ | EQS | GE | GT | LE | LT | NEQ | NEQS | OR | RP | SEMI ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_, _) = _menhir_stack in
          let (_endpos_e2_, e2) = (_endpos, _v) in
  ...
  and _menhir_run_037 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_035 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_MINUS as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
          _menhir_run_028 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | COMMA | EQ | EQS | GE | GT | LE | LT | MINUS | NEQ | NEQS | OR | PLUS | RP | SEMI ->
  ...
  and _menhir_run_031 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_029 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_expr -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
      let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_, _) = _menhir_stack in
      let (_endpos_e2_, e2) = (_endpos, _v) in
  ...
  and _menhir_run_027 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_025 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_expr -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
      let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_, _) = _menhir_stack in
      let (_endpos_e2_, e2) = (_endpos, _v) in
  ...
  and _menhir_run_023 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_expr _menhir_cell0_STAR -> _ -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
  ...
  and _menhir_run_021 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT _menhir_cell0_LP as 'stack) -> _ -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | STAR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
  ...
  and _menhir_run_114 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_list_gdef -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_list_gdef (_menhir_stack, _menhir_s, lgdef) = _menhir_stack in
      let g = _v in
      let _v = _menhir_action_32 g lgdef in
      _menhir_goto_list_gdef _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      ...
      | COMMA ->
          ...
          | TINT ->
              ...
              | IDENT _v_1 ->
                  let _tok = _menhir_lexer _menhir_lexbuf in
                  let (id, p) = (_v_1, _v) in
                  let _v = _menhir_action_34 id p in
                  _menhir_goto_params _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok
              | _ ->
                  _eRR ())
          | _ ->
