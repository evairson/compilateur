...
TESTS_FILES=("00_empty" "01_expr" "02_gvar" "03_func" "04_if" "05_AndOrNot" "06_if_rec" "07_while" "08_break_cont" "09_pointer")
...
for test_file in "${TESTS_FILES[@]}"; do
    ...
    ./exec.sh "$TEST_DIR/$test_file.c"

    # Vérifier le code de retour de diff via ton script
