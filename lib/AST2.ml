...
and iAST = | Ireturn of iexpr | Ival of iexpr | Icall of string * int (*nom + nb arguments*)| Iassign of left_value * iexpr

and value = | Ileft of left_value | Iconst of int

and left_value = pos * int  (* position in memory and size *)

and pos = | Ilocal of int (* offset to RBP *) | Iglobal of string | Ireg of string (*pour rdi et compagnie*)
